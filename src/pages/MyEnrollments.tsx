...
const MyEnrollments = () => {
  ...
  const handleDownloadReceipt = async (enrollmentId: number) => {
    try {
      await enrollmentService.downloadReceipt(enrollmentId)
  ...
  const handleDownloadFiche = async (enrollmentId: number) => {
    try {
      await enrollmentService.downloadFiche(enrollmentId)
                  ...
                  <div className="flex flex-col items-end space-y-4">
                    ...
                    {enrollment.statut === 'validé' && (
                      <div className="flex flex-col space-y-2">
                        <button 
                          onClick={() => handleDownloadFiche(enrollment.id_enrollement)}
                        ...
                        <button 
                          ...
                          className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5"
                        >
